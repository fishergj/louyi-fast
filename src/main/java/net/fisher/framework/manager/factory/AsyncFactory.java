package net.fisher.framework.manager.factory;
...
import net.fisher.common.utils.AddressUtils;
import net.fisher.common.utils.LogUtils;
...
import net.fisher.project.monitor.logininfor.domain.Logininfor;
import net.fisher.project.monitor.logininfor.service.LogininforServiceImpl;
...
import net.fisher.project.monitor.operlog.domain.OperLog;
import net.fisher.project.monitor.operlog.service.IOperLogService;

/**
 * 异步工厂（产生任务用）
 * 
 * @author jungao
 * @date Dec 13, 2018 4:40:45 PM
 */
