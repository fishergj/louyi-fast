package net.fisher.framework.shiro.service;
...
import net.fisher.common.constant.ShiroConstants;
...
import net.fisher.common.exception.user.UserDeleteException;
...
import net.fisher.project.system.user.domain.UserStatus;
import net.fisher.project.system.user.service.IUserService;

/**
 * 登录校验方法
 * 
 * @author jungao
 * @date Dec 13, 2018 4:14:11 PM
 */
@Component
