package net.fisher.framework.aspectj;
...
import net.fisher.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect {
	...
	// 配置织入点
	@Pointcut("@annotation(net.fisher.framework.aspectj.lang.annotation.Log)")
