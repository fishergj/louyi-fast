package net.fisher.common.utils.poi;
...
import net.fisher.framework.aspectj.lang.annotation.Excel;
...
public class ExcelUtil<T> {
	...
	public String getAbsoluteFile(String filename) {
		String downloadPath = LouYiConfig.getDownloadPath() + filename;
