package net.fisher.common.utils.file;
...
import net.fisher.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
	 ...
	 * 默认上传的地址
	 */
	private static String defaultBaseDir = LouYiConfig.getProfile();
