...
import net.fisher.common.utils.file.FileUploadUtils;
...
import net.fisher.framework.web.service.DictService;
...
public class ProfileController extends BaseController {
	...
	public AjaxResult updateAvatar(User user, @RequestParam("avatarfile") MultipartFile file) {
		try {
			if (!file.isEmpty()) {
				String avatar = FileUploadUtils.upload(LouYiConfig.getAvatarPath(), file);
