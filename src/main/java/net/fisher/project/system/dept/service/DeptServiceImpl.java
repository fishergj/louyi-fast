package net.fisher.project.system.dept.service;
...
import net.fisher.project.system.dept.domain.Dept;
import net.fisher.project.system.dept.mapper.DeptMapper;
