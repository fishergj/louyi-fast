...
import net.fisher.framework.config.GenConfig;
import net.fisher.project.tool.gen.domain.ColumnInfo;
import net.fisher.project.tool.gen.domain.TableInfo;
import net.fisher.project.tool.gen.mapper.GenMapper;
import net.fisher.project.tool.gen.util.GenUtils;
import net.fisher.project.tool.gen.util.VelocityInitializer;

/**
 * 代码生成 服务层处理
 * 
 * @author jungao
 * @date Dec 8, 2018 1:20:48 PM
 */
@Service("genService")
