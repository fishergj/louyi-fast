package net.fisher.project.monitor.logininfor.controller;
...
import net.fisher.project.monitor.logininfor.service.ILogininforService;

/**
 * 系统访问记录
 * 
 * @author jungao
 * @date Dec 13, 2018 5:09:02 PM
 */
@Controller
